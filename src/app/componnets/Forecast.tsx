    ...
    return (
        <div
            ...
            <div className={"text-center flex flex-col align-middle"}>
                <h4>Now</h4>
                <Image width={22} height={22} className={"p-2 fill-amber-200 md:max-w-[90px] md:m-auto w-full"} src="/ico/cloud_24dp.svg" alt=""/>
                <h4 className={"md:text-4xl"}>{kelvinToCelsius(weather?.main.temp || 0)}</h4>
            </div>
            <div className={"text-center flex flex-col align-middle"}>
                <h4>12 <span className={"text-xs"}>PM</span></h4>
                <Image width={22} height={22} className={"p-2 md:max-w-[90px] md:m-auto w-full"} src="/ico/cloud_24dp.svg" alt=""/>
                <h4 className={"md:text-4xl"}>{kelvinToCelsius(weather?.main.temp || 0)}</h4>
            </div>
            <div className={"text-center flex flex-col align-middle"}>
